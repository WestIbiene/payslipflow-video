...
// ============================================================================
// ILLUSTRATED PERSONAS -- Ana, Jenny, Jack. Built as inline SVG shapes, no
...
export type PersonVariant = 'ana' | 'jenny' | 'jack';
...
const PersonJenny: React.FC<{ expression: Expression; blinking: boolean }> = ({ expression, blinking }) => (
  <>
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: '50%', overflow: 'hidden' }}>
      <svg viewBox="0 0 200 200" width={size} height={size} style={{ transform: `translateY(${bob}px)` }}>
        ...
        {variant === 'jenny' && <PersonJenny expression={expression} blinking={isBlinking} />}
