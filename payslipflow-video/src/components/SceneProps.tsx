...
// The same Google Sheet icon used in the opening explainer scene, extracted
// here so both scenes render the exact same icon rather than two visually
// similar but separately-drawn copies.
export const SheetIcon: React.FC<{ size?: number }> = ({ size = 64 }) => (
